...
\myvec{1 &-1\\2 &3}\\
  \solution
		\input{solutions/inverse/1.tex}
%\  \input{solutions/su2021/25.tex}
\item Using elementary transforamtions, find the inverse of   
   \myvec{2 &1\\1 &1}\\
  \solution
		\input{solutions/inverse/2.tex}
