...
\begin{abstract}
This manual provides an introduction to linear equations  based on the NCERT textbooks from Class 6-12.  
\end{abstract}
...
\solution
\begin{enumerate}
\item %\input{solutions/sep/2/5/a/Assignment.tex}
\item 
\item %\input{solutions/sep/2/5/c/main.tex}
...
$
\myvec{m_1n_2-m_2n_1\\ n_1l_2-n_2l_1 \\ l_1m_2-l_2m_1}.
$
\item 
$\begin{alignedat}[t]{2}
x+2y&=2 
