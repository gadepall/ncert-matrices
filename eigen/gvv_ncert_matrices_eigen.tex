...
\title{
	Matrix Equations and the Cayley-Hamilton Theorem
}
...
\begin{abstract}
This manual provides some applications of the Cayley-Hamilton theorem, 
...
\begin{enumerate}
	\item $1+\alpha^{2}+\beta\gamma=0$ \item $1-\alpha^{2}+\beta\gamma=0$
	\item $1-\alpha^{2}-\beta\gamma=0$ \item $1+\alpha^{2}-\beta\gamma=0$
\end{enumerate}
\solution
...
\item If A=\myvec{3 &-2\\4 &-2} and I=\myvec{1 &0\\0 &1},find k\\
 so that $A^2=kA-2I$\\
 \solution
 %\input{solutions/oct/2/59/Assignment_2.tex}
\end{enumerate}
