...
\begin{align}
	\vec{a} = 
\end{align}
\rupee{30000} be divided into two parts $x_1$ and $x_2$ in part $\vec{a)}$,and into two part $y_1$ and $y_2$ in part $\vec{b)}$. Then $x_1,x_2,y_1,y_2$ satisfies following equations
\begin{align}
